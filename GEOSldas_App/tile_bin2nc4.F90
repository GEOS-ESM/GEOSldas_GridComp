...
contains
  ...
  FUNCTION getAttribute (SHORT_NAME, LNAME, UNT) result (str_atr)
    ...
    case ('TSURF', 'TPSURF', 'TPSURFLAND');    LONG_NAME = 'surface_temperature_of_land_incl_snow';                            UNITS = 'K' 
    ...
    case ('RUNSURF');                          LONG_NAME = 'overland runoff including throughflow';                            UNITS = 'kg m-2 s-1' 
    ...
    case ('FRUNST', 'FRUNSTLAND');             LONG_NAME = 'fractional_area_of_unsaturated_zone';                              UNITS = '1'
    case ('FRSAT' , 'FRSATLAND' );             LONG_NAME = 'fractional_area_of_saturated_zone';                                UNITS = '1'
    case ('FRSNO' , 'FRSNOLAND' );             LONG_NAME = 'fractional_area_of_snow_on_land';                                  UNITS = '1'
    case ('FRWLT' , 'FRWLTLAND' );             LONG_NAME = 'fractional_area_of_wilting_zone';                                  UNITS = '1'
