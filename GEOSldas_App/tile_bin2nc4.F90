...
contains
  ...
  FUNCTION getAttribute (SHORT_NAME, LNAME, UNT) result (str_atr)
    ...
    case ('EVPSBLN', 'LHLANDSBLN');            LONG_NAME = 'snowpack_evaporation_latent_heat_flux';                            UNITS = 'W m-2'
    ...
    case ('EVPSNO');                           LONG_NAME = 'snowpack_evaporation_latent_heat_flux';                            UNITS = 'W m-2'
